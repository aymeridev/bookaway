...
export function ProfilePage() {
    ...
    if ((isAuthenticated && !user) || isProfileLoading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
                ...
                <p className="text-gray-500 dark:text-gray-400 font-medium">Chargement de votre profil...</p>
            </div>
        );
    }
    ...
    if (!isAuthenticated || !user) {
        return (
            <div className="max-w-md mx-auto text-center py-20 px-4">
                ...
                <h2 className="text-xl font-bold text-gray-900 mb-2">Non connecté</h2>
                <p className="text-gray-500 mb-6">Veuillez vous connecter pour accéder à votre profil personnel.</p>
    ...
    return (
        <>
            <Banner title="Mon Profil" description="Gérez vos informations personnelles et consultez vos réservations" />
                            ...
                            <div className="w-full space-y-4 text-left">
                                <div className="flex items-center gap-3 text-gray-600 dark:text-gray-300">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <p className="text-xs text-gray-400 font-medium uppercase tracking-wider">Adresse email</p>
                                        <p className="text-sm font-semibold truncate text-gray-800 dark:text-gray-200">{user.email}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-3 text-gray-600 dark:text-gray-300">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <p className="text-xs text-gray-400 font-medium uppercase tracking-wider">Réservations</p>
                                        <p className="text-sm font-semibold text-gray-800 dark:text-gray-200">
